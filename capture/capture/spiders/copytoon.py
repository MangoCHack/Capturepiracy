...
class CopytoonSpider(scrapy.Spider):
    name = 'copytoon'
    #allowed_domains = ['copytoon202.com']
    start_urls = ['https://copytoon202.com/']
    ...
    def parse(self, response):
        ...
        '''
        webtoon_page='https://copytoon202.com/' #카피툰은 최신 업데이트 웹툰페이지 없음
        yield scrapy.Request(webtoon_page, callback=self.webtoonList)
    ...
    def webtoonCollect(self, response):
        ...
        DownloadUrl = response.css('.contents').xpath('.//div/img/@src').getall()[0]
